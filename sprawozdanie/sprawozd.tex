...
\item[•]Symulowane wy¿arzanie jest pochodn¹ algorytmu greedy, cechuje siê wiêkszym czasem dzia³ania i które w ekstremalnym przypadku ( obni¿enia temperatury ) mo¿emy sprowadziæ do algorytmu greedy. Jednak ustawianie odpowiedniej temperatury prowadziæ mo¿e do poszukania lepszego optimum, kosztem lokalnego pogorszenia wyników.
